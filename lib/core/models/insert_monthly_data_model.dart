...
//
//     final insertMonthlyDataModel = insertMonthlyDataModelFromJson(jsonString);

import 'dart:convert';

InsertMonthlyDataModel insertMonthlyDataModelFromJson(String str) => InsertMonthlyDataModel.fromJson(json.decode(str));

String insertMonthlyDataModelToJson(InsertMonthlyDataModel data) => json.encode(data.toJson());

class InsertMonthlyDataModel {
  int? code;
  Data? data;
  String? msg;
  ...
  factory InsertMonthlyDataModel.fromJson(Map<String, dynamic> json) => InsertMonthlyDataModel(
    code: json["code"],
