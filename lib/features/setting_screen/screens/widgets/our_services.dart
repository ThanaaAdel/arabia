...
class OurServiceScreen extends StatefulWidget {
  ...
  @override
  State<OurServiceScreen> createState() => _ContactUsScreenState();
}

class _ContactUsScreenState extends State<OurServiceScreen> {
  @override
  void initState() {
    ...
    return SafeArea(child: Scaffold(
      ...
      body: Column(children: [
        Padding(
          ...
          child: SharedAppbar(text: "our_services".tr()),
        ),
                      ...
                      children: [
                        Row(
                          children: [
                            ...
                            SizedBox(width: 10.w,),
                            AutoSizeText(
                                cubit.settingModel?.data![1].title ?? '',
                      ...
                      children: [
                        Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            borderRadius: BorderRadius.circular(8.sp),),
                          child: AutoSizeText(
                            cubit.settingModel?.data![1].content ?? '',
                          ),
                        ),
                      ],
                    ),
