...
class MonthlyContractRequestDetailsScreen extends StatelessWidget {
  const MonthlyContractRequestDetailsScreen({super.key, required this.item, this.onPressed, required this.isArchive, required this.inProgress});
 final Item item;
                      ...
                      child: Column(
                        children: [
                          ...
                          _buildDetailRow(
                            context,
                            "from_date".tr(),
                            formatDate(item.serviceDateFrom.toString() ??
                                ''),
                          ),
                          _buildDetailRow(
                            context,
                            "to_date".tr(),
                           formatDate( item.serviceDateTo.toString() ?? ''),
                          ),
                          _buildDetailRow(
                            context,
                            "nationality".tr(),
                          ...
                          _buildDetailRow(
                            context,
                            "total_cost".tr(),
                            item.costIncludeTax.toString() ??
                                '',
                          ),
                          _buildDetailRow(
                            context,
                            "order_status".tr(),
                            item.statusDisplay?.title.toString() ??
                                '',
                          ),
